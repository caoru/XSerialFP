...
XSFPHandler::XSFPHandler()
  : regex_("(^[a-zA-Z]{3})(N1|WX|AT|FD|BN0|BN1|BN2|BN3|BN4|BN5|BN6|BN7|R[0-9]|[a-zA-Z]{4}|[a-zA-Z]{3}|[a-zA-Z]{1}|[0-9]{5}|[+-]*[0-9]{3}|[+-])(C[0-9]|[a-zA-Z]{2}|[+]{2}|[-]{2}|[+-]|[0-9]{4}|[0-9])?")
{
}
...
void XSFPHandler::Parse(void)
{
  //std::regex message_regex("(^[a-zA-Z]{3})([a-zA-Z0-9]{2,3}|[a-zA-Z]{1}|[+-]?[0-9]{3,4}|[+-])([+-])?");
  //std::regex message_regex("(^[a-zA-Z]{3})([a-zA-Z0-9]{2,}|[a-zA-Z]{1}|[+-]?[0-9]{3,4}|[+-])([+-]+)?");
  //std::regex message_regex("(^[a-zA-Z]{3})(N1|[a-zA-Z]{4}|[a-zA-Z]{3}|[a-zA-Z]{1}|[+-]*[0-9]{3}|[+-])([+]{2}|[-]{2}|[+-]|[0-9]{4}|[0-9])?");
  //std::regex message_regex("(^[a-zA-Z]{3})(N1|WX|AT|FD|BN0|BN1|BN2|BN3|BN4|BN5|BN6|BN7|[a-zA-Z]{4}|[a-zA-Z]{3}|[a-zA-Z]{1}|[0-9]{5}|[+-]*[0-9]{3}|[+-])([a-zA-Z]{2}|[+]{2}|[-]{2}|[+-]|[0-9]{4}|[0-9])?");

  std::regex_search(message_, results_, regex_);
}


void XSFPHandler::Perform(std::string message)
{
  message_ = message;
  Parse();
  ...
  XSFPLog("[%s] %s %s %s",
          ...
          results_[3].str().c_str());

  if (results_[1] == "CDU") PerformCDU();
  else if (results_[1] == "SPD") PerformSPD();
  else if (results_[1] == "HDG") PerformHDG();
  else if (results_[1] == "ALT") PerformALT();
  else if (results_[1] == "VVS") PerformVVS();
  else if (results_[1] == "APL") PerformAPL();
  else if (results_[1] == "BAR") PerformBAR();
  else if (results_[1] == "NDM") PerformNDM();
  else if (results_[1] == "NDR") PerformNDR();
  else if (results_[1] == "EFI") PerformEFI();
  else if (results_[1] == "COM") PerformCOM();
  else if (results_[1] == "NAV") PerformNAV();
  else if (results_[1] == "ADF") PerformADF();
  else if (results_[1] == "DME") PerformDME();
  else if (results_[1] == "TRN") PerformTRN();
...
void XSFPHandler::PerformSPD(void)
{
  int intValue;
...
void XSFPHandler::PerformHDG(void)
{
  int intValue;
...
void XSFPHandler::PerformALT(void)
{
  int intValue;
...
void XSFPHandler::PerformVVS(void)
{
  int intValue;
...
void XSFPHandler::PerformAPL(void)
{
  int intValue;
  float floatValue;
...
void XSFPHandler::PerformBAR(void)
{
  int intValue;
...
void XSFPHandler::PerformNDM(void)
{
  int intValue;
...
void XSFPHandler::PerformNDR(void)
{
  int intValue;
...
void XSFPHandler::PerformEFI(void)
{
  int intValue;
...
void XSFPHandler::PerformCOM(void)
{
  int intValue;
  if (results_[2] == "SEL")
  {
...
void XSFPHandler::PerformNAV(void)
{
  int intValue;
...
void XSFPHandler::PerformADF(void)
{
  if (results_[2] == "SEL")
  {
  }
...
void XSFPHandler::PerformDME(void)
{
  if (results_[2] == "SEL")
  {
  }
...
void XSFPHandler::PerformTRN(void)
{
  int intValue;
...
void XSFPHandler::PerformCTL(void)
{
  if (results_[2] == "BN0")
  {
  }
