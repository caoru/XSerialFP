...
XSFPHandlerDefault::XSFPHandlerDefault()
{
}
...
void XSFPHandlerDefault::PerformCDU(void)
{
  int intValue = 1;
...
void XSFPHandlerDefault::PerformSPD(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformHDG(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformALT(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformVVS(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformAPL(void)
{
  int intValue;
  float floatValue;
...
void XSFPHandlerDefault::PerformBAR(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformNDM(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformNDR(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformEFI(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformCOM(void)
{
  int intValue;
  if (results_[2] == "SEL")
  {
...
void XSFPHandlerDefault::PerformNAV(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformADF(void)
{
  if (results_[2] == "SEL")
  {
  }
...
void XSFPHandlerDefault::PerformDME(void)
{
  if (results_[2] == "SEL")
  {
  }
...
void XSFPHandlerDefault::PerformTRN(void)
{
  int intValue;
...
void XSFPHandlerDefault::PerformCTL(void)
{
  if (results_[2] == "BN0")
  {
  }
